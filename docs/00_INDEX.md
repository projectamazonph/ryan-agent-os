...
27. [Phase 5 Agent Execution Build Log](27_PHASE5_BUILD_LOG.md)
...
- [ADR-0009: Auditable bounded agent runs](adr/0009-auditable-agent-runs.md)
...
- [Agent Definition JSON Schema](schemas/agent-definition.schema.json)
- [Agent Context Package JSON Schema](schemas/agent-context-package.schema.json)
- [Agent Run JSON Schema](schemas/agent-run.schema.json)
- [Agent Run Event JSON Schema](schemas/agent-run-event.schema.json)
- [Agent Tool Invocation JSON Schema](schemas/agent-tool-invocation.schema.json)
